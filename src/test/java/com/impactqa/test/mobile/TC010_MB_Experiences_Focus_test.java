...
public class TC010_MB_Experiences_Focus_test extends BaseTestMobile {
    ...
    public void verifyExperiencesMeditateAudioCards() throws InterruptedException {
        ...
        ExperiencesFocusPage experiencesFocusPage = new ExperiencesFocusPage(driver, platform);
        experiencesEscapePage.tapOnExperiences();
        experiencesFocusPage.tapOnFocus();
        experiencesFocusPage.selectRandomTracksFromFocusAndPlay();
