...
public class TC008_MB_Experiences_Energize_test extends BaseTestMobile {
    ...
    @Story("verify Experiences Energize audio Card ")
    ...
    public void verifyExperiencesMeditateAudioCards() throws InterruptedException {
        ...
        ExperiencesEnergizePage experiencesEnergizePage = new ExperiencesEnergizePage(driver, platform);
        experiencesEscapePage.tapOnExperiences();
        experiencesEnergizePage.tapOnEnergize();
        experiencesEnergizePage.selectRandomTracksFromEnergizeAndPlay();
