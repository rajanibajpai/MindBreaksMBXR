...
public class TC011_MB_Experiences_Inspire_test extends BaseTestMobile {
    ...
    public void verifyExperiencesMeditateAudioCards() throws InterruptedException {
        ...
        ExperiencesInspirePage experiencesInspirePage = new ExperiencesInspirePage(driver, platform);
        experiencesEscapePage.tapOnExperiences();
        experiencesInspirePage.tapOnInspire();
        experiencesInspirePage.selectRandomTracksFromInspireAndPlay();
