...
public class TC009_MB_Experiences_Rest_test extends BaseTestMobile {
    ...
    public void verifyExperiencesMeditateAudioCards() throws InterruptedException {
        ...
        ExperiencesRestPage experiencesRestPage = new ExperiencesRestPage(driver, platform);
        experiencesEscapePage.tapOnExperiences();
        experiencesRestPage.tapOnRest();
        experiencesRestPage.selectRandomTracksFromRestAndPlay();
